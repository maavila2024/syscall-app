...
function generate(ts, vueCompilerOptions, sourceTemplate, sourceLang, templateAst, hasScriptSetup, cssScopedClasses = []) {
    ...
    function visitElementNode(node, parentEl) {
        ...
        const tagText = (_b = componentVars[node.tag]) !== null && _b !== void 0 ? _b : node.tag;
        if (vueCompilerOptions.jsxTemplates) {
            ...
            const tagCapabilities = _isIntrinsicElement || _isNamespacedTag ? capabilitiesSet.all : capabilitiesSet.diagnosticOnly;
            codeGen.push(`<`);
            codeGen.push([
                tagText,
                'template',
    ...
    function writeProps(node, format, mode) {
        ...
        for (const prop of node.props) {
            if (prop.type === 7 /* CompilerDOM.NodeTypes.DIRECTIVE */
                ...
                if (!prop.arg) {
                    writePropName(attrNameText, isStatic, [prop.loc.start.offset, prop.loc.start.offset + 'v-model'.length], getCaps(capabilitiesSet.attr), (_c = prop.loc.name_1) !== null && _c !== void 0 ? _c : (prop.loc.name_1 = {}));
                }
