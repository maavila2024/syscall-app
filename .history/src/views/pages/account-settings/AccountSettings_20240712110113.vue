...
import UiParentCard from '@/src/components/shared/UiParentCard.vue';

/*import tabler icons*/
import { UserCircleIcon,BellIcon,ArticleIcon,LockIcon } from 'vue-tabler-icons';

//components
import AccountTab from '@/src/components/pages/account-settings/AccountTab.vue';
import NotificationTab from '@/src/components/pages/account-settings/NotificationTab.vue';
import BillsTab from '@/src/components/pages/account-settings/BillsTab.vue';
import SecurityTab from '@/src/components/pages/account-settings/SecurityTab.vue';
