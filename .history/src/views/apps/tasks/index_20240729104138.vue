    ...
    <div class="mb-5 pb-5 border-b border-opacity-100">
      <v-row align="center" justify="space-between">
        ...
        <v-col cols="12" lg="6" md="4" class="d-flex align-center">
          ...
          <v-radio-group v-model="selectedSegment" @change="updateUserSegment" row inline class="radio-button">
            <v-radio label="Todos" value="0" class="mr-2 radio-button"></v-radio>
            <v-radio label="Grãos" value="1" class="mr-2 radio-button"></v-radio>
            <v-radio label="Proteína" value="2" class="radio-button"></v-radio>
          </v-radio-group>
        </v-col>
...
watch(search, fetchTasks);
watch(selectedSegment, fetchTasks);
...
.radio-button {
  margin-top: 4px; /* Ajuste esse valor conforme necessário */
}
</style>
