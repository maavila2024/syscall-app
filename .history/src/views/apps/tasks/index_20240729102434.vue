      ...
      <v-row align="center" justify="space-between">
        ...
        <v-col cols="12" lg="6" md="4" class="d-flex align-center">
          ...
          <v-radio-group v-model="selectedSegment" @change="updateUserSegment" row>
            <v-radio label="Todos" value="0" class="mr-2" inline></v-radio>
            <v-radio label="Grãos" value="1" class="mr-2" inline></v-radio>
            <v-radio label="Proteína" value="2" inline></v-radio>
          </v-radio-group>
        </v-col>
