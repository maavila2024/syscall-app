...
.bg-total, .bg-aberto, .bg-desenvolvimento, .bg-aguardando, .bg-teste, .bg-concluido, .bg-homologacao, .bg-cancelado {
  min-height: 120px; /* Define uma altura mínima */
