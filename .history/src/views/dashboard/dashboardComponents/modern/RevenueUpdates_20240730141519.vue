...
const chartOptions = computed(() => {
    return {
        ...
        // },
        xaxis: {
            categories: ['Total Chamados mês', 'Aberto', 'Em desenvolvimento', 'Aguardando resposta', 'Enviado para teste', 'Concluído'],
            axisBorder: {
                show: false
            }
        },
    ...
    <v-card elevation="10" >
        <v-card-item>
            <div class="d-sm-flex align-center justify-space-between">
                <div>
                    <v-card-title class="text-h5">D-CONTROL CHAMADOS GRÃOS</v-card-title>
