...
const handleStatusChange = (value) => {
  if (value.includes("Todos")) {
    selectedStatuses.value = statusOptionsWithAll.value.length === value.length ? [] : statusOptionsWithAll.value.slice(1);
  }
};

const handleOwnerChange = (value) => {
  if (value.includes("Todos")) {
    selectedOwners.value = ownerOptionsWithAll.value.length === value.length ? [] : ownerOptionsWithAll.value.slice(1);
  }
};

const handleResponsibleChange = (value) => {
  if (value.includes("Todos")) {
    selectedResponsibles.value = responsibleOptionsWithAll.value.length === value.length ? [] : responsibleOptionsWithAll.value.slice(1);
  }
};

const handlePriorityChange = (value) => {
  if (value.includes("Todos")) {
    selectedPriorities.value = priorityOptionsWithAll.value.length === value.length ? [] : priorityOptionsWithAll.value.slice(1);
  }
};

const handleComplexityChange = (value) => {
  if (value.includes("Todos")) {
    selectedComplexities.value = complexityOptionsWithAll.value.length === value.length ? [] : complexityOptionsWithAll.value.slice(1);
  }
};
