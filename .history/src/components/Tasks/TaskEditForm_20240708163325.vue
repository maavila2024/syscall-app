...
const submit = handleSubmit(async (payload) => {
  ...
  if (payload.expected_date) {
    payload.expected_date = format(new Date(payload.expected_date), 'yyyy-MM-dd');
  }
  if (payload.finish_date) {
    payload.finish_date = format(new Date(payload.finish_date), 'yyyy-MM-dd');
  }
  
  console.log( payload.expected_date)
