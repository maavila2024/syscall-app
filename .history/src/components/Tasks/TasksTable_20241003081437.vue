        ...
        <tfoot>
          <tr>
            <td colspan="8" class="text-right">
              <strong style="font-size: 16px; font-weight: bold; margin-right: 20px;">Total de Chamados:</strong>
              <span style="font-size: 18px; font-weight: bold; color: #ffffff;">{{ filteredTasks.length }}</span>
            </td>
          </tr>
        </tfoot>
      </v-table>
