...
// Inicializar todos os filtros como selecionados
watch([tasks, showStatusFilter, showOwnerFilter, showResponsibleFilter, showPriorityFilter, showComplexityFilter], () => {
  if (showStatusFilter.value) selectedStatuses.value = [...statusOptions.value];
  if (showOwnerFilter.value) selectedOwners.value = [...ownerOptions.value];
  if (showResponsibleFilter.value) selectedResponsibles.value = [...responsibleOptions.value];
  if (showPriorityFilter.value) selectedPriorities.value = [...priorityOptions.value];
  if (showComplexityFilter.value) selectedComplexities.value = [...complexityOptions.value];
});

// Estado do checkbox "Selecionar todos"
const selectAllStatuses = ref(true);
const selectAllOwners = ref(true);
const selectAllResponsibles = ref(true);
const selectAllPriorities = ref(true);
const selectAllComplexities = ref(true);
