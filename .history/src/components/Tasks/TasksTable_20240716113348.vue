...
// Inicializar todos os filtros selecionados
...
// Chamar a função de inicialização ao mostrar o filtro pela primeira vez
watch([showStatusFilter, showOwnerFilter, showResponsibleFilter, showPriorityFilter, showComplexityFilter], (newValues, oldValues) => {
  if (newValues.some((newValue, index) => newValue && !oldValues[index])) {
...
const handleStatusChange = (value) => {
  if (value.includes('Desmarcar Todos')) {
