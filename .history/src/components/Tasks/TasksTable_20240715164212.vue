  ...
  <v-table class="border-opacity-100">
    <thead>
      <tr>
        ...
        <th class="text-left" style="width: 100px;">Título</th>
        <th class="text-left" style="width: 100px;">Descrição</th>
        <th class="text-left" style="width: 100px;">Solicitante</th>
        <th class="text-left" style="width: 100px;">Responsável</th>
        <th class="text-left" style="width: 100px;">Status</th>
        <th class="text-left" style="width: 100px;">Prioridade</th>
        <th class="text-left" style="width: 100px;">Complexidade</th>
