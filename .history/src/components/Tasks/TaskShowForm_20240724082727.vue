...
const sequence = ref(props.task.sequence);
...
const finish_date = ref(
  props.task.finish_date ? props.task.finish_date.split("T")[0] : null
);
const expected_date = ref(
  props.task.expected_date ? props.task.expected_date.split("T")[0] : null
);
const created_at = ref(
  props.task.created_at ? props.task.created_at.split("T")[0] : null
);
