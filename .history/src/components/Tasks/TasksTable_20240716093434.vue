...
const handleStatusChange = (value) => {
  if (value.includes("Todos") && selectedStatuses.value.length !== statusOptionsWithAll.value.length - 1) {
...
const handleOwnerChange = (value) => {
  if (value.includes("Todos") && selectedOwners.value.length !== ownerOptionsWithAll.value.length - 1) {
    selectedOwners.value = ownerOptionsWithAll.value.slice(1);
  } else {
    selectedOwners.value = value;
  }
};

const handleResponsibleChange = (value) => {
  if (value.includes("Todos") && selectedResponsibles.value.length !== responsibleOptionsWithAll.value.length - 1) {
    selectedResponsibles.value = responsibleOptionsWithAll.value.slice(1);
  } else {
    selectedResponsibles.value = value;
  }
};

const handlePriorityChange = (value) => {
  if (value.includes("Todos") && selectedPriorities.value.length !== priorityOptionsWithAll.value.length - 1) {
...
const handleComplexityChange = (value) => {
  if (value.includes("Todos") && selectedComplexities.value.length !== complexityOptionsWithAll.value.length - 1) {
    selectedComplexities.value = complexityOptionsWithAll.value.slice(1);
  } else {
    selectedComplexities.value = value;
  }
};
