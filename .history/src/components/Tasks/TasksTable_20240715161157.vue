<template>
  <v-table class="border-opacity-100">
    <thead>
      <tr>
        <th class="text-left" tyle="width: 100px;">Chamado</th>
        <th class="text-left" tyle="width: 100px;">Título</th>
        <th class="text-left" tyle="width: 250px;">Descrição</th>
        <th class="text-left" tyle="width: 100px;">Solicitante</th>
        <th class="text-left" tyle="width: 100px;">Responsável</th>
        <th class="text-left" tyle="width: 300px;">Status</th>
        <th class="text-left" tyle="width: 100px;">Prioridade</th>
        <th class="text-left" tyle="width: 100px;">Complexidade</th>
        <th class="text-left" tyle="width: 100px;">Ações</th>
        <th></th>
      </tr>
    </thead>
    ...
    <tbody>
      <tr v-for="(task, i) in tasks" :key="i" :style="getStatusStyle(task.task_status)">
        ...
        <td>
          <div class="truncate-text">{{ task.name }}</div>
          <v-chip
            v-if="task.default"
            size="small"
            variant="tonal"
