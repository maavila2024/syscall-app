...
const focusFirstErrorField = () => {
  if (errors.complexityRef) {
    nextTick(() => refs.complexityRef.value.focus());
  } else if (errors.complexityJustificationRef) {
    nextTick(() => refs.complexityJustificationRef.value.focus());
  } else if (errors.responsibleRef) {
    nextTick(() => refs.responsibleRef.value.focus());
  }
};
