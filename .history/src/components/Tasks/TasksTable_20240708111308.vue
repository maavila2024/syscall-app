        ...
        <td>
          <v-hover>
            <template v-slot:default="{ isHovering }">
              <v-tooltip bottom v-if="isHovering" :text="task.complexity.complexity_justification || 'Aguardando análise'">
                <span>{{ task.complexity.complexity_justification || "Aguardando análise" }}</span>
              </v-tooltip>
              <span>{{ task.complexity.complexity_justification || "Aguardando análise" }}</span>
            </template>
          </v-hover>
