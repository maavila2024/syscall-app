  ...
  <v-menu :close-on-content-click="false">
    <template v-slot:activator="{ props }">
      <v-btn icon variant="text" color="primary" v-bind="props">
        <v-badge
          dot
          :color="unreadNotifications.length > 0 ? 'error' : '#F44336'"
          class="custom-dot"
        >
          <BellIcon stroke-width="1.5" size="32" />
        </v-badge>
      </v-btn>
    </template>
...
.custom-dot .v-badge__dot {
  width: 12px; /* Ajuste aqui para o tamanho desejado */
  height: 12px; /* Ajuste aqui para o tamanho desejado */
}
