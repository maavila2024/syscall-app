...
<template>
    ...
    <v-menu :close-on-content-click="false">
        ...
        <v-sheet rounded="md" width="360" elevation="10">
            <div class="px-8 pt-6">
                <h6 class="text-h5 font-weight-medium">Dados do usuário</h6>
                <div class="d-flex align-center mt-4 pb-6">
                    <v-avatar size="80">
                        <img src="@/assets/images/profile/user-1.jpg" width="80" />
                    </v-avatar>
                    <div class="ml-3">
                        <h6 class="text-h6 mb-n1">{{  meStore.user.first_name }}</h6>
                        <span class="text-subtitle-1 font-weight-regular textSecondary"></span>
                        <div class="d-flex align-center mt-1">
                            <MailIcon size="18" stroke-width="1.5" />
                            <span class="text-subtitle-1 font-weight-regular textSecondary ml-2">{{  meStore.user.email }}</span>
                        </div>
                    </div>
                </div>
                <v-divider></v-divider>
            ...
            <div class="pt-4 pb-6 px-8 text-center">
                <v-btn color="primary" variant="outlined" block :to="{ name: 'logout' }">Logout</v-btn>
            </div>
        </v-sheet>
    </v-menu>
</template>
